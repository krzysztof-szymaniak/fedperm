...
from config import dataset, input_shape, grid_shape, show, model_name, info_dir, classes, subinput_shape, shape
...
def test():
    ...
    permutations = generate_permutations(seed, grid_shape, subinput_shape, shape=shape)
    ...
    identity = generate_permutations(0, grid_shape, subinput_shape, shape=shape)
